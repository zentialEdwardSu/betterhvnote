...
object TransferPermissions {
    ...
    fun missingNotePermissions(context: Context): Array<String> =
        missing(context, noteRuntimePermissions())

    fun missingPhonePermissions(context: Context): Array<String> =
        missing(context, phoneRuntimePermissions())
