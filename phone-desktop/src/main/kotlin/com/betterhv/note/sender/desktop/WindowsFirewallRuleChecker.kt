...
internal data class FirewallCommandResult(val exitCode: Int?, val output: String, val timedOut: Boolean = false)
...
internal class WindowsFirewallRuleChecker(
  ...
  private data class FirewallRuleSnapshot(
    ...
    fun isConfigured(): Boolean = enabled.equals("True", ignoreCase = true) &&
