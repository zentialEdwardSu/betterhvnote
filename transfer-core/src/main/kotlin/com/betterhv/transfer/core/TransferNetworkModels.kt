...
data class DeviceCapabilities(
  ...
  companion object {
    const val SSID_FINGERPRINT_BYTES = 8
  }
}

data class CapabilityNegotiation(val remote: DeviceCapabilities, val ssidMatch: SsidMatch)
...
object TransferNetworkSecurity {
  ...
  fun ssidFingerprint(pairingKey: ByteArray, rawSsid: String?): ByteArray? = normalizeSsid(rawSsid)?.let { normalized ->
