...
class SecureFrameChannel(
    ...
    private val sendPrefix: Int,
    private val receivePrefix: Int
) {
    ...
    @Synchronized fun seal(type: MessageType, requestId: UUID, plaintext: ByteArray): ProtocolFrame {
        ...
        return ProtocolFrame(type, requestId, counter,
    ...
    fun open(frame: ProtocolFrame): ByteArray {
        ...
        return TransferCrypto.decrypt(
            key, TransferCrypto.nonce(receivePrefix, frame.counter), frame.payload,
