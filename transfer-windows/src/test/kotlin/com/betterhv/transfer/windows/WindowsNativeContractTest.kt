...
private class FakeLibrary : NoteLinkNativeLibrary {
  ...
  override fun nl_protect(input: Pointer?, inputLength: Int, output: Pointer?, outputCapacity: Int) =
    transform(input, inputLength, output, outputCapacity)
  override fun nl_unprotect(input: Pointer?, inputLength: Int, output: Pointer?, outputCapacity: Int) =
    transform(input, inputLength, output, outputCapacity)
