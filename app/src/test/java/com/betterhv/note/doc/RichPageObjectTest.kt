...
class RichPageObjectTest {
    ...
    fun exifQuarterTurnSwapsImageLocalBounds() {
        val image = ImageObject(
            UUID.randomUUID(), assetPath = "assets/portrait.jpg", mimeType = "image/jpeg",
            pixelWidth = 4000, pixelHeight = 3000, exifOrientation = 6
        )
    ...
    fun textStyleUpdateIsUndoableAndSnapshotKeepsRichObjects() {
        ...
        val before = TextObject(
            id = UUID.randomUUID(), text = "hello", fontSize = 24f,
        ...
        val image = ImageObject(
            UUID.randomUUID(), assetPath = "assets/example.png", mimeType = "image/png",
