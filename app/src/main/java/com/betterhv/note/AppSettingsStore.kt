...
class AppSettingsStore(context: Context) {
  ...
  var skipSourceSelectionWhenQueueAvailable: Boolean
    ...
    set(value) = preferences.edit { putBoolean(KEY_SKIP_SOURCE_SELECTION, value) }

  var autoCreatePageOnNextAtEnd: Boolean
    get() = preferences.getBoolean(KEY_AUTO_CREATE_PAGE, false)
    set(value) = preferences.edit { putBoolean(KEY_AUTO_CREATE_PAGE, value) }
  ...
  var toolbarHidden: Boolean
    ...
    set(value) = preferences.edit { putBoolean(KEY_TOOLBAR_HIDDEN, value) }
  ...
  var toolbarDockEdge: DockEdge
    ...
    set(value) = preferences.edit { putString(KEY_TOOLBAR_DOCK_EDGE, value.name) }

  var toolbarDockFraction: Float
    get() = preferences.getFloat(KEY_TOOLBAR_DOCK_FRACTION, 0.5f).coerceIn(0f, 1f)
    set(value) = preferences.edit { putFloat(KEY_TOOLBAR_DOCK_FRACTION, value.coerceIn(0f, 1f)) }
