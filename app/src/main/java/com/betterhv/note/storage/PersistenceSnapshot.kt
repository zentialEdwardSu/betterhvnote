...
data class PageSnapshot(val metadata: Notebook.PageMetadata, val objects: List<PageObject>) {
  companion object {
...
data class ObjectChange(val pageId: UUID, val objectId: UUID, val value: PageObject?)
