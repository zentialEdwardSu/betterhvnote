...
enum class NoteLanguage(val storageId: String) {
  ...
  companion object {
    fun fromStorageId(value: String?): NoteLanguage = entries.firstOrNull { it.storageId == value } ?: SYSTEM
  }
}
...
fun noteText(chinese: String, english: String): String = if (NoteI18n.isChinese) chinese else english
